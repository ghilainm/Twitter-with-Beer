...
public class TwitterImplementation extends java.rmi.server.UnicastRemoteObject implements TwitterAPI{
	...
	*/
	...
	@Override
	public LinkedList<String> allUsersFromLine(String lineName, String userName) throws RemoteException, ValueNotFoundException, NotLoggedException {
		handler.isLogged();
